...
\begin{description}
    \item [ROC] (Receiver Operating Characteristic) curve is the plot of the efficiency of the second class $\epsilon_1$ against the false rate $1 - \epsilon_0$ of the first class for different thresholds. 
