...
% We also introduce the concept of pile-up, which refers to the additional collisions occurring in the same bunch crossing and its impact on the identification of jets.
...
% We discuss the input variables used for training the algorithms, the training configuration of each network, and the results obtained in terms of the transverse momentum, pseudo-rapidity, and pile-up dependence of the jet tagging algorithms. 
